 ...
 */
export async function discoverController(db: Db, q: DiscoveryQueryType, viewerId: string | null = null): Promise<DiscoveryResult> {
  const result = await discover(db, q, viewerId);

...
export async function updateUser(
  db: Db,
  id: string,
  fields: Partial<{ name: string; language: string; theme: string; havdalahOpinion: string; sharePhone: boolean; acceptMessages: boolean; isAdmin: boolean; status: string; suspendedUntil: Date | null }>,
) {
